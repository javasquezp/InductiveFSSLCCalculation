...
%             end
        ...
        function [D, Freqs, Info] = GetSYZParams(this, TreePath, varargin)
            ...
            iTreeItemsWithFloquetPort = contains(TreeItems, 'S1,2') | contains(TreeItems, 'S1,1');
...
%             if ~exist(MacroDir, 'dir'),  mkdir(MacroDir);  end
            ...
            if isempty(RunIDs),
               ...
               % TreeItem = '1D Results\S-Parameters\SZmax(1),Zmax(1)';  % Tree item from which we will get all Result IDs
